...
/**
 * macOS-adapted VerticalFastScroller and VerticalGridFastScroller.
 *
 * Ported from presentation-core's VerticalFastScroller.kt. Key changes:
 * - Replaced `android.view.ViewConfiguration` animation constants with fixed values
 * - Removed `Modifier.systemGestureExclusion()` (no Android gesture system on desktop)
 * - Dropped unused preview code
 */
...
/**
 * Desktop scroll constants — replace Android ViewConfiguration values.
 */
private const val SCROLL_BAR_FADE_DURATION_MS = 500
private const val THUMB_FADE_DELAY_MS = 2000
...
private val FadeOutAnimationSpec = tween<Float>(
    ...
    delayMillis = THUMB_FADE_DELAY_MS,
)
...
/**
 * Scroller key prefix for sticky headers.
 * External callers should use `Scroller.STICKY_HEADER_KEY_PREFIX`.
 */
object Scroller {
